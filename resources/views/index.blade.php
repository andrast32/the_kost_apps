                ...
                <div class="owl-carousel owl-banner">
                    ...
                    <div class="item item-1">
                        <div class="header-text">
                            <span class="category">Bandung, <em>Jabar</em></span>
                            <h2>hurry! <br>get the best <span style="color: #e6d29c;">Kontrakan</span> <br> for you</h2>
                        </div>
                    </div>

                    <div class="item item-2">
                        <div class="header-text">
                            <span class="category">Malang, <em>Jatim</em></span>
                            <h2>hurry! <br>get the best <span style="color: #e6d29c;">Kontrakan</span> <br> for you</h2>
                        </div>
                    </div>
                    ...
                    <div class="item item-3">
                        <div class="header-text">
                            <span class="category">Jakarta, <em>DKI</em></span>
                            <h2>hurry! <br>get the best <span style="color: #e6d29c;">Kontrakan</span> <br> for you</h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="left-image">
                                <img src="{{ asset('UI/utama/assets/images/featured.jpg') }}" alt="foto rumah kiri">
                                <a href="kamar/">
                                    <img src="{{ asset('UI/utama/assets/images/featured-icon.png') }}" alt="icon" style="max-width: 60px; padding: 0px;">
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            ...
                                            <a href="https://www.google.com/search?q=best+free+css+templates" target="_blank">best free CSS templates</a>
                        ...
                        <div class="col-lg-3">
                            <div class="info-table">
                                <ul>
                                    ...
                                    <li>
                                        <img src="{{ asset('UI/utama/assets/images/info-icon-01.png') }}" alt="" style="max-width: 52px;">
                                        <h4>250 m2<br><span>Total Flat Space</span></h4>
                                    </li>

                                    <li>
                                        <img src="{{ asset('UI/utama/assets/images/info-icon-02.png') }}" alt="" style="max-width: 52px;">
                                        <h4>Contract<br><span>Contract Ready</span></h4>
                                    </li>

                                    <li>
                                        <img src="{{ asset('UI/utama/assets/images/info-icon-03.png') }}" alt="" style="max-width: 52px;">
                                        <h4>Payment<br><span>Payment Process</span></h4>
                                    </li>

                                    <li>
                                        <img src="{{ asset('UI/utama/assets/images/info-icon-04.png') }}" alt="" style="max-width: 52px;">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="appartment" role="tabpanel" aria-labelledby="appartment-tab">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <img src="{{ asset('UI/utama/assets/images/deal-01.jpg') }}" alt="">
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="villa" role="tabpanel" aria-labelledby="villa-tab">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <img src="{{ asset('UI/utama/assets/images/deal-02.jpg') }}" alt="">
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="penthouse" role="tabpanel" aria-labelledby="penthouse-tab">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <img src="{{ asset('UI/utama/assets/images/deal-03.jpg') }}" alt="">
                                                </div>
