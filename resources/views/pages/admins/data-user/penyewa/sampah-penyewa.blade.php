                        ...
                        <tr align="center">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <form action="{{ route('data-user.penyewa.restore', $data->id) }}" id="restore-{{ $data->id }}" method="post" style="display: none">
                                        @csrf
                                        @method('PUT')
                                    </form>

                                    <form action="{{ route('data-user.penyewa.force-delete', $data->id) }}" id="delete-{{ $data->id }}" method="post" style="display: none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
